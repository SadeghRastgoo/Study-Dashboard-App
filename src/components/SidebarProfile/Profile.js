...
const Profile = () => {
  return (
    <div className="sidebar-profile__profile">
      <img
        className="sidebar-profile__avatar animate__animated  animate__zoomIn "
      ...
      <h3 className="sidebar-profile__username text-base">
        ...
        <svg
          ...
          height="16"
          fill="currentColor"
          className="bi bi-check-circle-fill animate__animated animate__zoomIn animate__delay-1s"
          viewBox="0 0 16 16"
        >
